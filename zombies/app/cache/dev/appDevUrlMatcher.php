...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/js')) {
            ...
            if (0 === strpos($pathinfo, '/js/a6efff1')) {
                // _assetic_a6efff1
                if ($pathinfo === '/js/a6efff1.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'a6efff1',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_a6efff1',);
                }

                // _assetic_a6efff1_0
                if ($pathinfo === '/js/a6efff1_part_1_googlemap_1.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'a6efff1',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_a6efff1_0',);
                }
        ...
        if (0 === strpos($pathinfo, '/css/247e8ee')) {
            // _assetic_247e8ee
            if ($pathinfo === '/css/247e8ee.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '247e8ee',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_247e8ee',);
            }

            // _assetic_247e8ee_0
            if ($pathinfo === '/css/247e8ee_part_1_main_1.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '247e8ee',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_247e8ee_0',);
            }
        ...
        // zombies_game_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'zombies_game_homepage')), array (  '_controller' => 'Zombies\\GameBundle\\Controller\\DefaultController::indexAction',));
        }
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'manage_map');
            }

            return array (  '_controller' => 'Zombies\\GameBundle\\Controller\\DefaultController::indexAction',  '_route' => 'manage_map',);
        }

        // create_location
        if (0 === strpos($pathinfo, '/create') && preg_match('#^/create/(?P<coordinates>[^/]++)/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'create_location')), array (  '_controller' => 'Zombies\\GameBundle\\Controller\\DefaultController::createAction',));
        }

        // show_location
        if (0 === strpos($pathinfo, '/show') && preg_match('#^/show/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'show_location')), array (  '_controller' => 'Zombies\\GameBundle\\Controller\\DefaultController::showAction',));
        }

        // update_location
        if (0 === strpos($pathinfo, '/update') && preg_match('#^/update/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'update_location')), array (  '_controller' => 'Zombies\\GameBundle\\Controller\\DefaultController::updateAction',));
        }

        // delete_location
        if (0 === strpos($pathinfo, '/delete') && preg_match('#^/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'delete_location')), array (  '_controller' => 'Zombies\\GameBundle\\Controller\\DefaultController::deleteAction',));
        }
