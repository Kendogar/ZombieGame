...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'coordinates.manager' => 'getCoordinates_ManagerService',
            ...
            'inhabitants.manager' => 'getInhabitants_ManagerService',
            ...
            'place.manager' => 'getPlace_ManagerService',
            'profiler' => 'getProfilerService',
            'profiler_listener' => 'getProfilerListenerService',
            'property_accessor' => 'getPropertyAccessorService',
            'request' => 'getRequestService',
            'request_stack' => 'getRequestStackService',
            'resources.manager' => 'getResources_ManagerService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ZombiesGameBundle', ($this->targetDirs[2].'/Resources/ZombiesGameBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ZombiesGameBundle', ($this->targetDirs[3].'\\src\\Zombies\\GameBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'coordinates.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Zombies\GameBundle\Utils\CoordinatesService A Zombies\GameBundle\Utils\CoordinatesService instance.
     */
    protected function getCoordinates_ManagerService()
    {
        return $this->services['coordinates.manager'] = new \Zombies\GameBundle\Utils\CoordinatesService();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'zombies', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Zombies\\GameBundle\\Resources\\config\\doctrine') => 'Zombies\\GameBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Zombies\\GameBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ZombiesGameBundle' => 'Zombies\\GameBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f4065989d2c3ff110adbac1fa165cb2f5c5ecfdda74111ee3d7d3e1e217ae057');
    ...
    /**
     * Gets the 'inhabitants.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Zombies\GameBundle\Utils\InhabitantsService A Zombies\GameBundle\Utils\InhabitantsService instance.
     */
    protected function getInhabitants_ManagerService()
    {
        return $this->services['inhabitants.manager'] = new \Zombies\GameBundle\Utils\InhabitantsService();
    }
    ...
    /**
     * Gets the 'place.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Zombies\GameBundle\Utils\PlaceService A Zombies\GameBundle\Utils\PlaceService instance.
     */
    protected function getPlace_ManagerService()
    {
        return $this->services['place.manager'] = new \Zombies\GameBundle\Utils\PlaceService();
    }
    ...
    /**
     * Gets the 'resources.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Zombies\GameBundle\Utils\ResourcesService A Zombies\GameBundle\Utils\ResourcesService instance.
     */
    protected function getResources_ManagerService()
    {
        return $this->services['resources.manager'] = new \Zombies\GameBundle\Utils\ResourcesService();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'ZombiesGameBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Zombies\\GameBundle/Resources/views'), 'ZombiesGame');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f0c36ead8aff41ef804925835ad54788cdf338d8');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ZombiesGameBundle' => 'Zombies\\GameBundle\\ZombiesGameBundle',
            ...
            'locale' => 'en',
            'secret' => 'f0c36ead8aff41ef804925835ad54788cdf338d8',
            ...
            'kernel.secret' => 'f0c36ead8aff41ef804925835ad54788cdf338d8',
